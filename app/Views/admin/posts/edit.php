        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?= form_open(sprintf('admin/post/update/%d', $post->id)); ?>
                    <?= form_hidden('id', set_value('id', $post->id)); ?>
                    <div class="form-group">
                        <label for="title">Title</label>
                        <input type="text" name="title" class="form-control" value="<?php echo set_value('title', $post->title); ?>" aria-describedby="titleHelpBlock" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="content" id="post_content" class="form-control" aria-describedby="contentHelpBlock" required><?php echo set_value('content', $post->content); ?></textarea>
